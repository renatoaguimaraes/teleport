...
// NewClusterNetworkingConfig is a convenience method to to create ClusterNetworkingConfigV2.
...
func DefaultClusterNetworkingConfig() ClusterNetworkingConfig {
	return &ClusterNetworkingConfigV2{
		Kind:    KindClusterNetworkingConfig,
		Version: V2,
		Metadata: Metadata{
			Name:      MetaNameClusterNetworkingConfig,
...
func (c *ClusterNetworkingConfigV2) SetName(e string) {
	c.Metadata.Name = e
}
