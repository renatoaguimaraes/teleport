...
func (c *Client) GetClusterNetworkingConfig(ctx context.Context, skipValidation bool) (types.ClusterNetworkingConfig, error) {
	req := &types.ConfigResourceRequest{SkipValidation: skipValidation}
	resp, err := c.grpc.GetClusterNetworkingConfig(ctx, req, c.callOpts...)
	if err != nil {
		return nil, trail.FromGRPC(err)
	}
	return resp, nil
