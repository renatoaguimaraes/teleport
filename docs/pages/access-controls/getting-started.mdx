...
Members of `editor` role can modify cluster configuration, members of the `auditor` role can view audit logs, and `access` members can access cluster resources.
