...
Currently, there is no option to provide your key.
...
Currently, there is no way to provide your bucket.
...
We are pursuing SOC2 for the cloud and expect to receive our report at the end of Q2 2021
