...
1. A client connects to the Proxy Server and provides the target Node's host and port location. There are three lookup mechanisms a proxy uses to find the
   Node's IP address:
