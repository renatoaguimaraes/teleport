...
- [Authenticating to EKS Using GitHub Credentials with Teleport Open Source](#using-teleport-with-eks)
...
2. Using SSH public/private keys has several limitations. Read why [SSH Certificates are better](https://gravitational.com/blog/ssh-key-management/).
...
needed to set up a URL for the proxy - we recommend using a subdomain.
...
Create TLS certificate for HTTPs. It is crucial to properly configure TLS
...
More resources for Enterprise customers:
